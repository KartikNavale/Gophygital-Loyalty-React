...
//   const totalPages = Math.ceil(RuleEngine.length / itemsPerPage);
//   const currentItems = RuleEngine.slice(
...
//                           <input className="on-off-toggler form-check-input my-2" type="checkbox" />
//                         </span>
//                       </td>
//                       <td>
