...
const MemberDetails = () => {
  ...
  const getMemberDetails = async (id) => {
    try {
      const response = await axios.get(`https://staging.lockated.com/loyalty/members/${id}.json?token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414`);
                ...
                <div class="go-shadow mx-3 no-top-left-shadow ">
                  ...
                  <div class="row px-3">
                    <div class="col-lg-8 col-md-12 col-sm-12 row px-3">
                      ...
                      <div class="col-6 p-1 member-detail-color">: {member.firstname} {member.lasttname} </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Email Address</div>
                      <div class="col-6 p-1 member-detail-color">: {member.email}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Phone No.</div>
                      <div class="col-6 p-1 member-detail-color">: {member.phone}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Home Address</div>
                      <div class="col-6 p-1 member-detail-color">: {member.address.address1} {member.address.address2} </div>
                    </div>
                ...
                <div class="go-shadow mx-3 no-top-left-shadow ">
                  ...
                  <div class="row px-3">
                    <div class="col-lg-8 col-md-12 col-sm-12 row px-3">
                      ...
                      <div class="col-6 p-1 member-detail-color">: {member.current_loyalty_points}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Tier Progress</div>
                      <div class="col-6 p-1 member-detail-color">: {member.member_status.tier_progression}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Membership Duration </div>
                      <div class="col-6 p-1 member-detail-color">: Name</div>   {/* this attribute is not there in  json*/}
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                    ...
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      ...
                      <div class="col-6 p-1 member-detail-color">: {member.created_at}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Tier Level</div>
                      <div class="col-6 p-1 member-detail-color">: {member.member_status.tier_level}</div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-12 row px-3">
                      <div class="col-6 p-1 text-muted member-detail-color">Expiry Points</div>
                      <div class="col-6 p-1 member-detail-color">: 20/02/2024 </div>   {/* this attribute is not there in  json*/}
                    </div>
