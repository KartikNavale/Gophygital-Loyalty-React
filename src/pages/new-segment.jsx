...
const NewSegment = () => {
  ...
  const handleFilter = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.get("https://staging.lockated.com/loyalty/members.json?q[joining_date_gteq]=&q[created_at_lteq]=&q[loyalty_tier_name_eq]=&q[birth_date_lteq]=&q[gender_eq]=&q[active_eq]=&token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414", {
