                ...
                <Modal.Body>
                  <form onSubmit={handleFormSubmit}>
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" id="tierName" name="name" value={formData.name} onChange={handleInputChange} required />
                    </div>
                    <div className="mb-3">
                      <label htmlFor="campaignTag" className="form-label">Campaign Tag</label>
                      <input type="text" className="form-control" id="campaignTag" name="campaign_tag" value={formData.campaign_tag} onChange={handleInputChange} required />
                    </div>
                    <div className="mb-3">
