        ...
        <div className="module-data-section mt-2">
          ...
          <form onSubmit={formik.handleSubmit} className='go-shadow me-3 pt-3'>
            <div className="border-bottom pb-2">
              ...
              <div className="row ms-1 mt-4">
                <fieldset className="border col-lg-3 col-md-5 col-sm-11 me-2">
                  ...
                  {formik.touched.target_audiance && formik.errors.target_audiance ? (
                ...
                <fieldset className="border col-lg-3 col-md-5 col-sm-11">
                  ...
                  {formik.touched.loyalty_tier_id && formik.errors.loyalty_tier_id ? (
            ...
            <div className="row mt-2 justify-content-center">
              ...
              <div className="col-md-2">
                <button type="button" className="purple-btn2 w-100" onClick={formik.handleReset}>Cancel</button>
              </div>
            </div>
          </form>
        </div>
